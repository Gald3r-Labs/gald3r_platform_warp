...
| `AGENT_ORCHESTRATION` | The `@g-go` pipeline discipline, delegation, swarm coordination, curation. | `g-skl-delegate`, `g-skl-curator`, `g-skl-oracle`, rules `g-rl-00`/`g-rl-33`/`g-rl-37` |
