...
- Guard helpers: `gald3r workspace member guard`, `.claude/skills/g-skl-git-commit/scripts/gald3r_push_gate.py`, `.claude/skills/g-skl-git-commit/scripts/gald3r_housekeeping_commit.py`
