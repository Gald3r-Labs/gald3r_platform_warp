...
- id: disk-space-check
  schedule: "0 * * * *"
  no_agent: true
  script: .gald3r_sys/skills/g-skl-medic/scripts/watchdog_disk_space.ps1
  output: terminal

- id: stale-worktree-check
  schedule: "0 */6 * * *"
  no_agent: true
  script: .gald3r_sys/skills/g-skl-medic/scripts/watchdog_stale_worktrees.ps1
  output: terminal

- id: gald3r-sync-drift-check
  schedule: "*/30 * * * *"
  no_agent: true
  script: .gald3r_sys/skills/g-skl-medic/scripts/watchdog_sync_drift.ps1
  output: log
...
- The three example watchdog scripts above are illustrative health checks; create the
  referenced scripts under `.gald3r_sys/skills/g-skl-medic/scripts/` (or repoint `script:`
