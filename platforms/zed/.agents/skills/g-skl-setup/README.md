...
8. **Write `gald3r-skills-lock.json`** (T1043) — SHA-256 hashes of every installed `SKILL.md`. Lets `gald3r validate` detect tampering and `UPGRADE` flows classify which skills changed.
