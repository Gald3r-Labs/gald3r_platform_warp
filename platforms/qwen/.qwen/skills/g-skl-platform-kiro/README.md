...
Authoritative reference for Kiro IDE (Amazon) customization in gald3r projects. Covers .kiro/steering/ layout, spec-driven development, hooks, and gald3r install verification.

## When to use

- Invoke via `@g-skl-platform-kiro` (or when the agent determines this skill is relevant)
