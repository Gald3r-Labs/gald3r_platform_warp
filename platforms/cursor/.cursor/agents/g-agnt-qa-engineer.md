...
> This agent's role brief is now a centralized prompt asset (`role.qa_engineer`) served by the bundled
> engine. For installs without the engine, read the full brief directly at
> `.gald3r_sys/engine/src/gald3r/prompts/assets/role.qa_engineer.md`.
